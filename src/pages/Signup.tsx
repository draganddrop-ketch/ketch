    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-500 text-sm uppercase tracking-wide">Create Account</p>
        </div>
        ...
        <div className="bg-zinc-900 border border-white/30 p-8">
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-white mb-2 uppercase tracking-wide">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
